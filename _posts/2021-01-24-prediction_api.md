---
title: Building a prediction API using FastAPI and Docker
excerpt: Most of the times your model is used behind the scenes, interacting with other components and providing its results through APIs. Let's see how to do it!
...
- Docker
header:
  teaser: https://paulo-blog-media.s3-sa-east-1.amazonaws.com/posts/2021-01-24-prediction_api/teaser_image.jpg
classes: wide
s3_bucket: https://paulo-blog-media.s3-sa-east-1.amazonaws.com/posts/2021-01-24-prediction_api
repo_name: prediction_api
---
...
<img src="{{ page.s3_bucket }}/request.jpg" alt="">
</figure>
...
<figure style="width: 75%"  class="align-center">
<img src="{{ page.s3_bucket }}/ok.jpg" alt="">
</figure>
...
<figure style="width: 75%"  class="align-center">
<img src="{{ page.s3_bucket }}/error.jpg" alt="">
</figure>
...
<figure style="width: 75%"  class="align-center">
<img src="{{ page.s3_bucket }}/docs.jpg" alt="">
</figure>
